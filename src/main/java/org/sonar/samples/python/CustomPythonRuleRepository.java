...
import org.sonar.python.checks.AvoidTooLongLineCheck;
import org.sonar.python.checks.AvoidTooManyLinesInFileCheck;
import org.sonar.samples.python.checks.AvoidCommentingCodePartsCheck;
import org.sonar.samples.python.checks.AvoidWrongNameCheck;
...
public class CustomPythonRuleRepository implements RulesDefinition, PythonCustomRuleRepository {
  ...
  public void define(Context context) {
    ...
    remediationCosts.put(AvoidWrongNameCheck.RULE_KEY, "10min");
    remediationCosts.put(AvoidTooLongLineCheck.RULE_KEY, "10min");
    remediationCosts.put(AvoidTooManyLinesInFileCheck.RULE_KEY, "10min");
    remediationCosts.put(AvoidCommentingCodePartsCheck.RULE_KEY, "10min");
  ...
  public List<Class> checkClasses() {
    return Arrays.asList(CustomPythonVisitorCheck.class, CustomPythonSubscriptionCheck.class, AvoidWrongNameCheck.class,
            AvoidCommentingCodePartsCheck.class,AvoidTooManyLinesInFileCheck.class, AvoidTooLongLineCheck.class);
  }
