...
import jdk.internal.jline.internal.Log.Level;
...
import static jdk.internal.jline.internal.Log.Level.*;
...
public class MyPhpRules implements RulesDefinition, PHPCustomRuleRepository {
  ...
  public ImmutableList<Class> checkClasses() {
    return ImmutableList.of(
            ForbiddenFunctionUseCheck.class, OtherForbiddenFunctionUseCheck.class,
            AvoidCommentingCodePartsCheck.class, AvoidTooLongMethodsCheck.class, AvoidTooManyConditionsInMethodCheck.class,
            AvoidLongLineCheck.class, AvoidTooManyMethodsCheck.class
    );
  }
  ...
  public void define(Context context) {
    ...
    Map<String, String> remediationCosts = new HashMap<>();
      ...
      remediationCosts.put(AvoidCommentingCodePartsCheck.KEY, "5min");
      remediationCosts.put(AvoidTooLongMethodsCheck.KEY, "5min");
      remediationCosts.put(AvoidTooManyConditionsInMethodCheck.KEY, "5min");
      remediationCosts.put(AvoidLongLineCheck.KEY, "5min");
      remediationCosts.put(AvoidTooManyMethodsCheck.KEY, "5min");
